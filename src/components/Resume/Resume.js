  ...
  const sectionDiv = {
            ...
            <div className={styles.item} key={item.title}>
              ...
              {item.location ? (
                <p className={styles.date}>
                  <MapPin /> {props.information["Work Experience"].details[0].location}
                </p>
              ) : (
                <span />
              )}
    ...
    [sections.interest]: (
      <div
        key={"interest"}
        draggable
        onDragOver={() => seTarget(info.interest?.id)}
        onDragEnd={() => setSource(info.interest?.id)}
        className={`${styles.section} ${info.interest?.sectionTitle ? "" : styles.hidden
          }`}
      >
        <div className={styles.sectionTitle}>{info.interest?.sectionTitle}</div>
        <div className={styles.content}>
          <p className={styles.overview}>{info?.interest?.detail}</p>
        </div>
      </div>
    ),
    [sections.technical]: (
